 ...
 *
 */
public class MultiLineCommentPartitionRule extends MultiLineRule implements IScannablePartitionRule {

	private final static String contentType = AsciidocDocumentPartitionScanner.MULTI_LINE_COMMENT;
	
	public MultiLineCommentPartitionRule() {
	...
	public static class PartitionScanner extends AbstractPartitionScanner {
		...
		public PartitionScanner() {
			...
			// TODO: need to add generic whitespace rule ?
