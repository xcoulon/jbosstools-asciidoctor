...
public final class Logger {
	...
	private static final String INFO = AsciidocTextEditorActivator.PLUGIN_ID + "/info";

	/** The 'debug' level name, matching the .options file. */
	private static final String DEBUG = AsciidocTextEditorActivator.PLUGIN_ID + "/debug";

	/** The 'trace' level name, matching the .options file. */
	private static final String TRACE = AsciidocTextEditorActivator.PLUGIN_ID + "/trace";
	...
	public static IStatus error(final String message, final Throwable t) {
		if (AsciidocTextEditorActivator.getDefault() != null) {
			final Status status = new Status(Status.ERROR, AsciidocTextEditorActivator.PLUGIN_ID, message, t);
			AsciidocTextEditorActivator.getDefault().getLog()
					.log(status);
			return status;
		} else {
	...
	public static void error(final String message) {
		AsciidocTextEditorActivator.getDefault().getLog()
				.log(new Status(Status.ERROR, AsciidocTextEditorActivator.PLUGIN_ID, message));
	}
	...
	public static void warn(final String message, final Throwable t) {
		AsciidocTextEditorActivator.getDefault().getLog()
				.log(new Status(Status.WARNING, AsciidocTextEditorActivator.PLUGIN_ID, message, t));
	}
	...
	public static void warn(final String message) {
		AsciidocTextEditorActivator.getDefault().getLog()
				.log(new Status(Status.WARNING, AsciidocTextEditorActivator.PLUGIN_ID, message));
	}
	...
	public static void info(String message) {
		if (isOptionEnabled(INFO)) {
			AsciidocTextEditorActivator.getDefault().getLog()
					.log(new Status(Status.INFO, AsciidocTextEditorActivator.PLUGIN_ID, message));
		}
	}
	...
	private static boolean isOptionEnabled(String level) {
		...
		return AsciidocTextEditorActivator.getDefault() != null && AsciidocTextEditorActivator.getDefault().isDebugging()
