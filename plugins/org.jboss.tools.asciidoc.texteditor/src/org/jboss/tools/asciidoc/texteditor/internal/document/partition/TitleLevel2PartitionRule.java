 ...
 *
 */
public class TitleLevel2PartitionRule extends PatternRule implements IScannablePartitionRule {

	private final static String contentType = AsciidocDocumentPartitionScanner.TITLE_LEVEL_2;
	
	public TitleLevel2PartitionRule() {
	...
	public static class PartitionScanner extends AbstractPartitionScanner {
		...
		public PartitionScanner() {
			...
			final Token token = new Token(
					createTextAttribute(contentType, SWT.BOLD, SWT.NORMAL));
